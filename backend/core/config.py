...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: list[str] = ["http://192.168.1.50", "http://localhost:3000", "https://admin.mi-pos.com", "http://localhost:5500", "http://127.0.0.1:5500", "https://juanpablobello8-byte.github.io"]
